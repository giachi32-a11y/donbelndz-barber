...
const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbztrvRE27_XBaKPSPHbXCFiD2Y31yWljjIgRPQZHgUXZFgwJZ7fEtLp7NzI_c0s5HLhfg/exec";
    ...
    <>
      ...
      {showSplash && (
        <div style={styles.splash}>
          ...
          <div style={styles.loadingText}>V 2.6</div>
        </div>
      )}
