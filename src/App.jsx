...
const styles = {
  ...
  mainButton: { background: THEME.goldGradient, color: '#000', border: 'none', padding: '16px 40px', borderRadius: '14px', fontSize: '1rem', fontWeight: '700', width: '100%', maxWidth: '280px', cursor: 'pointer', textAlign: 'center', boxShadow: '0 8px 166px rgba(212, 175, 55, 0.15)' },
  ...
  staffBtn: { background: 'transparent', color: THEME.gold, border: 'none', fontSize: '0.7rem', fontWeight: 'bold', letterSpacing: '2px', opacity: 0.6, cursor: 'pointer', padding: '15px', textTransform: 'uppercase' }
};
    ...
    <>
      ...
      {showSplash && (
        <div style={styles.splash}>
          ...
          <div style={styles.loadingText}>V 2.5</div>
        </div>
      )}
            ...
            <div style={styles.homeContent}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: '30px', marginTop: '30px', paddingBottom: '10px' }}>
                ...
                <a href="https://www.tiktok.com/@donblendz" target="_blank" rel="noopener noreferrer">
                  <img src="https://cdn.pixabay.com/photo/2021/06/15/12/28/tiktok-6338429_1280.png" alt="TikTok" style={{ width: '32px', height: '32px' }} />
                </a>
              </div>
            </div>
          } />
        ...
        <Route path="/servizi" element={
          <div style={{width: '100%', maxWidth: '400px', paddingTop: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
            ...
            <div style={{marginBottom: '15px', textAlign: 'center', width: '100%'}}>
              ...
              {[ {n: "Decolorazione", p: "70,00 €"}, {n: "Mesh", p: "60,00 €"} ].map(s => (
         ...
         <Route path="/prenota" element={
          <div style={{width: '100%', maxWidth: '360px', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', paddingTop: '20px'}}>
            ...
            <div style={{position: 'relative', width: '100%', maxWidth: '300px', height: '55px'}}>
              <label style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: THEME.goldGradient, borderRadius: '12px', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: '0 4px 15px rgba(212, 175, 55, 0.2)', zIndex: 1 }}>
                <span style={{ color: '#000', fontWeight: '800', fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '1px' }}>
                  {dataSel ? dataSel.split('-').reverse().join('/') : "📅 APRI CALENDARIO"}
                </span>
                <input type="date" min={todayStr} onChange={(e) => handleDateChange(e.target.value)} 
                  style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', opacity: 0, cursor: 'pointer', zIndex: 2, appearance: 'none', WebkitAppearance: 'none' }} 
                />
              </label>
            </div>
